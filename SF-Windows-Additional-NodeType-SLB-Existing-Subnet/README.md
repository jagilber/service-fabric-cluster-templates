# Additional Nodetype for Windows Service Fabric Cluster with standard load balancer and Automatic OS Upgrade to an existing subnet

[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure-Samples%2Fservice-fabric-cluster-templates%2Fmaster%2FsubnetPrefixSF-Windows-Additional-NodeType-SLB-Existing-Subnet%2FAzureDeploy.json)
[![Visualize](http://armviz.io/visualizebutton.png)](http://armviz.io/#/?load=https%3A%2F%2Fraw.githubusercontent.com%2FAzure-Samples%2Fservice-fabric-cluster-templates%2Fmaster%2FsubnetPrefixSF-Windows-Additional-NodeType-SLB-Existing-Subnet%2FAzureDeploy.json)

This template allows you to deploy an additional node type to an existing Service Fabric Cluster running Windows Server 2022 Datacenter on a Standard_DS4_v2 Size Virtual Machine Scale set to an existing subnet. Bronze clusters are considered development clusters and should not be used in production. Template requires an existing Service Fabric cluster and an existing `nodeTypes` configuration. See [NodeTypeDescription](https://learn.microsoft.com/azure/templates/microsoft.servicefabric/clusters?pivots=deployment-language-arm-template#nodetypedescription-1)
...
- Existing Virtual Network Name: testvnet
- Existing Subnet Name: testsubnet
